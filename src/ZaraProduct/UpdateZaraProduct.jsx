...
const UpdateZaraProduct = () => {
    ...
    const handleUpdateProduct = (event) => {
      ...
      fetch(`https://b8a10-brandshop-server-side-ct1feotw0-fahmida-khans-projects.vercel.app/products/Zara/${_id}`, {
        method: "PUT",
        headers: {
          ...
          <div className="form-control">
            ...
            <label className="input-group">
              ...
              >
                ...
                <option value="Zara" defaultValue={brandname}>Zara</option>
...
export default UpdateZaraProduct;